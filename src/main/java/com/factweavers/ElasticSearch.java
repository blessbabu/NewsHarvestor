...
public class ElasticSearch {
	...
	public Client createClient(String ip, int port, String cluster){
		System.out.println("creating new client : "+ip+"  "+port+"  "+cluster);
		if(client ==null){
...
//	Client client=es.createClient("52.33.234.9",9300, "drone-data");
//	GetResponse response = client.prepareGet("drones-col", "items", "566bffea66381a188560e221659d9adfc3db2e6e")
//	        .execute()
//	        .actionGet();
